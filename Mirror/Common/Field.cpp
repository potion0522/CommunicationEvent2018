...
void Field::drawFirstOrSecond( ) const {
	...
	if ( _first ) {
		_drawer->setFrontString( true, DECISION_BUTTON_X - 250, DECISION_BUTTON_Y, WATER, "先攻", Drawer::SUPER_BIG );
	} else {
		_drawer->setFrontString( true, DECISION_BUTTON_X - 250, DECISION_BUTTON_Y, WATER, "後攻", Drawer::SUPER_BIG );
	}
}
